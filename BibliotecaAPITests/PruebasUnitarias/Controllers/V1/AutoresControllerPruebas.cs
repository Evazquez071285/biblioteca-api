...
namespace BibliotecaAPITests.PruebasUnitarias.Controllers.V1
{
    ...
    public class AutoresControllerPruebas: BasePruebas
    {
        ...
        public async Task Get_RetornaAutor_CuandoAutorConIdExiste()
        {
            // Preparación
            var context = ConstruirContext(nombreBD);
            context.Autores.Add(new Autor { Nombres = "Emmanuel", Apellidos = "Vazquez Viveros" });
            context.Autores.Add(new Autor { Nombres = "Miriam", Apellidos = "Viveros" });
        ...
        public async Task Put_ActualizaAutor_CuandoEnviamosAutorSinFoto()
        {
            ...
            Assert.AreEqual(expected: "Ayuliet2", actual: autorActualizado.Nombres);
            Assert.AreEqual(expected: "Camacho2", actual: autorActualizado.Apellidos);
        ...
        public async Task Patch_ActualizaUnCampo_CuandoSeLeEnviaUnaOperacion()
        {
            ...
            var patchDoc = new JsonPatchDocument<AutorPatchDTO>();
            patchDoc.Operations.Add(new Operation<AutorPatchDTO>("replace", "/nombres", null, "Bianca2"));
            ...
            Assert.AreEqual(expected: "Bianca2", autorBD.Nombres);
            Assert.AreEqual(expected: "Dorantes", autorBD.Apellidos);
            Assert.AreEqual(expected: "859", autorBD.Identificacion);
